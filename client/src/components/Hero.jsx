...
const Hero = () => {
	...
	return (
		<motion.div
			...
			className='min-h-screen pt-10 flex flex-col items-center justify-center gap-14 bg-light text-center'>
			...
			<motion.form
				...
				<div className='flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8'>
					...
					<div className='flex flex-col items-start gap-2'>
						...
						<input value={returnDate} onChange={(e) => setReturnDate(e.target.value)} type="date" id="return-date" disabled={!pickupDate} min={pickupDate} className='text-sm text-gray-500' required />
					</div>
				</div>
