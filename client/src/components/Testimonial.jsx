...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            image: assets.testimonial_image_1,
            testimonial: "I highly recommend CarRental! Their fleet is amazing, and I always feel like I'm getting the best deal with exciting service."
        }
    ];
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <Title title="What our Customers Say" subTitle="Drive with ease and confidence — CarRental offers quality car rentals tailored to your travel needs, wherever you go." />
