...
const Navbar = () => {
    ...
    return (
        <motion.div
            ...
            className={`flex items-center justify-between px-6 xl:px-32 py-4 text-gray-600 border-b border-borderColor relative transition-all ${location.pathname === "/" && "bg-light"}`}>
