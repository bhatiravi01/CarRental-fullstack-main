    ...
    return (
        <div>
            ...
            <motion.div
                ...
                <p className='text-gray-500 max-w-7xl mx-auto'>Showing {filteredCars.length} Cars</p> {/* xl:px-20 was present in the original */}

                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4 max-w-7xl mx-auto'> {/* xl:px-20 was present in the original */}
